...
class CustomDialogEmptyField extends StatelessWidget {
  ...
  const CustomDialogEmptyField({Key? key, this.title, this.subTitle}) : super(key: key);
      ...
      child: SizedBox(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Lottie.asset('assets/images/empty_box.json', height: 100, width: 100),
              const SizedBox(
                height: 10,
              ),
              Text(
...
class CustomDialogError extends StatelessWidget {
  ...
  const CustomDialogError(
      {Key? key, this.title = "Error", this.subTitle = "Something went wrong,try again"})
      : super(key: key);
...
class CustomDialogImagePicker extends StatelessWidget {
  ...
  const CustomDialogImagePicker({Key? key, this.onCameraClick, this.onGalleryClick})
      : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              FadeInImage.assetNetwork(
                placeholder: 'assets/images/placeholder_image.png',
                image: 'https://thumbs.gfycat.com/UniqueSizzlingFinwhale-max-1mb.gif',
                height: 48,
                width: 48,
              ),
              const SizedBox(
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          ...
                          backgroundColor: AppColors.colorDeepRed,
